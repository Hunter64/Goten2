defmodule GotenWeb.FormEmployeComponent do
  ...
  def render(assigns) do
    ~L"""
    <div id="form_employe" class="ml-10 mt-32">
      <form id="form1" class="w-full max-w-lg" phx-submit="save_new_employe" phx-target="#form_employe">
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full md:w-1/2 px-3">
            <button type="submit" form="form1" class="mt-6 w-full py-3 bg-teal-500 text-white hover:bg-teal-400 items-center inline-flex font-bold rounded shadow focus:shadow-outline focus:outline-none rounded">
